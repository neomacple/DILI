...
### TREE Information ###
class_names = ["No-DILI" if label == 0 else "DILI" for label in y_train]
fig = plt.figure(figsize=(150,100))
tree.plot_tree(model, class_names=class_names, rounded=True)
plt.show()
plt.savefig('dili_dt_tree.png')
dt_model_text = tree.export_text(model, class_names=class_names)
print(dt_model_text)